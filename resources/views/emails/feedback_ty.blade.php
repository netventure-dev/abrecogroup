                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div <p><span style="font-size: 14px; color: #000;"> Hi
                                                                        {{ $details['name'] }}, <br><br> </p>
                                                                        <p style="margin: 0;">
                                                                            Thank you for your feedback. </p>
                                                                        <p>We appreciate your intrest in our services, and our team will get back to you shortly.</p>
                                                                        <p>If you require any additional information or have further questions, please do not hesitate to contact us. We are always happy to assist you.</p>
                                                                        <p>Have a good one.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
