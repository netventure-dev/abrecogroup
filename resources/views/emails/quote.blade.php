...
<body style="background-color:#ffffff;">
    <div style="background-color:#ffffff;">
        <div style="background:#0c0c0c;background-color:#202020;margin:0px auto;max-width:600px;">
                            ...
                            <div class="mj-column-per-100 outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:20px 0px 20px 0px;word-break:break-word;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:100px;">
                                                                <img alt="popularmaruti" height="auto"
                            ...
                            <div class="mj-column-per-100 outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:30px 0px 12px 0px;word-break:break-word;">
                                                <div
                                                    style="font-family:Ubuntu, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000;">
                                                    <p><span style="font-size: 16px; color: #000;"> Hi {{@$details['admin_name']}}, <br>
                                                            You have received a request rates.</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:18px 0px 0px 0px;word-break:break-word;">
                                                <div
                                                    style="font-family:Ubuntu, sans-serif;font-size:11px;line-height:1.5;text-align:center;color:#000;margin-bottom:20px;">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        role="presentation"
                                                        style="vertical-align:top;    margin: 0 auto;" width="80%">
                                                        <tr style="background: #ffff;">
                                                            <td style="padding: 10px;" align="left">
                                                                <p><span
                                                                        style="font-size: 14px; color: #000;">{{ 'Name' }}:</span>
                                                                </p>
                                                            </td>
                                                            <td style="padding: 10px;" align="left">
                                                                <p><span
                                                                        style="font-size: 14px; color: #000;">{{ @$details['name'] }}</span>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr style="background: #ffff;">
                                                            <td style="padding: 10px;" align="left">
                                                                <p><span
                                                                        style="font-size: 14px; color: #000;">{{ 'Service' }}:</span>
                                                                </p>
                                                            </td>
                                                            <td style="padding: 10px;" align="left">
                                                                <p><span
                                                                        style="font-size: 14px; color: #000;">{{ @$details['service'] }}</span>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr style="background: #ffff;">
                                                            <td style="padding: 10px;" align="left">
                                                                <p><span
                                                                        style="font-size: 14px; color: #000;">{{ 'Phone' }}:</span>
                                                                </p>
                                                            </td>
                                                            <td style="padding: 10px;" align="left">
                                                                <p><span
                                                                        style="font-size: 14px; color: #000;">{{ @$details['phone'] }}</span>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr style="background: #ffff;">
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="vertical-align: middle; color: #000000; font-family: inherit; font-size: 14px; padding-left: 15px; padding-right: 15px; padding-top: 15px; text-align: center;">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e3ebed; color: #000000; width: 680px;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    style="margin: 0; color: #333332; direction: ltr; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 50px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                                    <span class="tinyMce-placeholder">Thank You</span>
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:20px;padding-left:60px;padding-right:60px;padding-top:10px;">
                                                                <div
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-top:30px;width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img alt="Chocolate eggs"
                                                                        class="big"
                                                                        src= "{{ asset('assets/front/images/back.jpg') }}"
                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div align="center"
                                                                    style="font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;text-align:center;">
                                                                    <div height="10"> </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding:0 2px 0 2px;"><a
                                                                                    ...
                                                                                    target="_blank"><img
                                                                                        ...
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 2px 0 2px;"><a
                                                                                    href="https://www.youtube.com/channel/UCFbk8Kt0cqLK7YUTFxEaicA"
                                                                                    target="_blank"><img
                                                                                        alt="YouTube" height="32"
                                                                                        src= "{{ asset('assets/front/images/youtube.png') }}"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="YouTube"
                                                                                        width="32" /></a></td>
                                                                        </tr>
