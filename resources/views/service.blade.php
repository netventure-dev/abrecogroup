    ...
    <section class="slider-section">
        <div class="slides owl-theme owl-carousel">
            <div class="shadow-sm border-radius-new">
                <img src="{{ asset('storage/' . $service->cover_image) }}" class="img-fluid d-block" alt="INTELLECT WORKS">
    ...
    <section class="section2 section d-flex" order='{{ @$content2->order }}'>
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                class="float-left pr-4 pb-4 w-50 shadow rounded img-fluid img1 m-0" alt="INTELLECT WORKS">

                <!-- right image -->
                <!-- <img src="{{ asset('storage/' . $content2->image) }}" 
                class="float-right pl-4 pb-4 w-50 shadow rounded img-fluid img1 m-0" alt="INTELLECT WORKS"> -->
