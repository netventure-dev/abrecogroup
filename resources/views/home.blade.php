...
<body>
    <div class="container" style="background-color:#48789b">
        <div class="header">
            <a style="text-decoration:none" href="{{route('home')}}"><img src="{{asset('assets/images/login_steel.png')}}" class="logo">
                <div class="title_col"><h1>METCON</h1></div>
            </a>
            <nav>
                <ul>
                    {{-- <li><a href="">Home</a></li>
                    ...
                    <tbody>
                        ...
                        <input type="hidden" name="size_count" id="size_count" value="{{$sizes->count()}}">
                            @foreach($sizes as $key => $size)
                                <input type="hidden" name="size_id_{{$key}}" id="size_id_{{$key}}" value="{{$size->id}}">
                                <tr>
                                    <td id="size" class="text_white text-size">{{$size->size}}</td>
                                    <td class="text_white"><input id="weight_{{$key}}" onkeyup="weight_change('{{$key}}');" type="number" disabled class="form-control text-size btn-st" name="weight_{{$key}}"></td>
                                    <td class="text_white "><input id="rods_{{$key}}" onkeyup="rod_change('{{$key}}');" type="number" disabled class="form-control text-size btn-st" name="rods_{{$key}}"></td>
                                    <td class="text_white "><input id="bundles_{{$key}}" onkeyup="bundle_change('{{$key}}');" type="number" disabled class="form-control text-size btn-st" name="bundles_{{$key}}"></td>
                                    <td class="text_white "><input id="rods_new_{{$key}}"  type="number" disabled class="form-control text-size btn-st" name="rods_new_{{$key}}"></td>
                                    <td class="text_white "><input id="rate_{{$key}}" onkeyup="rate_change('{{$key}}')" type="number" disabled class="form-control text-size btn-st" name="rate_{{$key}}"></td>
                                    <td class="text_white "><input id="amt_{{$key}}" type="number" disabled class="form-control text-size btn-st text-right" name="amt_{{$key}}"></td>
                                </tr>
                            @endforeach
                        @endif
                        <tr>
