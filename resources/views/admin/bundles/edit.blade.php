                    ...
                    <div class="mt-2 row">
                        <div class="col-lg-7">
                            <form action="{{ route('admin.bundles.update', $bundle->id) }}" method="post"
                                ...
                                @method('post')
                                <div class="mb-4 row">
                                    <label for="bundles" class="col-sm-3 col-form-label">No. of bundles<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input id="bundles" name="bundles" type="text"
                                            class="form-control @if ($errors->has('bundles')) is-invalid @endif"
                                            placeholder="Enter no. of bundles" required value="{{ @old('bundles',@$bundle->no_of_bundles) }}">
                                        <div class="invalid-feedback">{{ $errors->first('bundles') }}</div>
                                    </div>
                                </div>
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="rods" name="rods" type="text"
                                            ...
                                            placeholder="Enter no. of rods" required value="{{ @old('rods',@$bundle->no_of_rods) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="weight" name="weight" type="number"
                                            class="form-control @if ($errors->has('weight',@$bundle->weight)) is-invalid @endif"
                                            placeholder="Enter weight in kgs" required value="{{ @old('weight',@$bundle->weight) }}">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="size_id" name="size_id"
                                            ...
                                            @foreach ($sizes as $data)
                                                <option @if($data->id == $bundle->size_id) selected @endif value={{ $data->id }}>{{ $data->size }}</option>
                                            @endforeach
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="rate" name="rate" type="number"
                                            ...
                                            placeholder="Enter rate" value="{{ @old('rate',@$bundle->rate) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check form-check-inline col-form-label">
                                            <input @if($bundle->status == 1) checked @endif class="form-check-input" type="checkbox" value="1"
