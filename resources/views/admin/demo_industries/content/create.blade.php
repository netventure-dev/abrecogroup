...
@section('title') {{ __('Create Demo Industry Content') }} @endsection
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Create Demo Industry Content') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.demo_industries.content.store',@$industries->uuid) }}" method="post"
                                ...
                                <div class="mt-4 row">
                                    <label class="col-sm-3 col-form-label" for="mobile_image">{{ __('Mobile_image') }}<a
                                            href="#" class="tool_tip js-tooltip-enabled" data-toggle="tooltip"></a></label>
                                    <div class="col-sm-9"> 
                                ...
                                <div class="mt-4 row">
                                    <label class="col-sm-3 col-form-label" for="order">{{ __('Order') }}<span
