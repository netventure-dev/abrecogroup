...
@section('title') {{ __('Create Milestone') }} @endsection
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Create Milestone') }}</h4>
                <div class="page-title-right">
                <a href="{{ route('admin.milestone.settings.index') }}"
                            class="btn btn-primary w-md">{{ __('Milestone') }}</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.milestone.settings.store') }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    <label for="name" class="col-sm-3 col-form-label mb-2">{{ __('Color') }}<span
                                                            class="text-danger">*</span></label>
                                        <div class="col-md-6 @error('color.1') is-invalid @enderror">
                                            <div class="form-material">
                                                <input type="text" class="form-control colorpicker" id="color-1" name="color[1]"
                                                    placeholder="Please provide color" value="{{ @old('color.1') }}" required>
