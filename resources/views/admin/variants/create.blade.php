...
@section('title') {{__('Create Variant')}} @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">{{__('Create Variant')}}</h4>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="mt-2 row">
                    <div class="col-lg-7">
                        <form action="{{ route('admin.variants.store') }}" method="post" class="custom-validation"
                                ...
                                <div class="col-sm-9">
                                    <select id="sub_model" name="sub_model"
                                        ...
                                        @foreach ($sub_models as $sub_model)
                                            <option value={{ $sub_model->id }}>{{ $sub_model->name }}</option>
                                        @endforeach
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-9">
                                    <input id="on_road_price" name="on_road_price" type="number"
                                        ...
                                        placeholder="Enter On Road Price" required value="{{ @old('on_road_price') }}">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-9">
                                    <input id="offer" name="offer" type="number"
                                        ...
                                        placeholder="Enter offer in Rs" value="{{ @old('offer') }}">
