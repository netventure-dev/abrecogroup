                            ...
                            <form action="{{ route('admin.casestudies.update', $case->uuid) }}" method="post"
                                    ...
                                    <div class="col-sm-9">
                                        <select id="service" name="service" class="form-select" required>
                                            ...
                                            @foreach ($services as $service)
                                                <option @if ($service->uuid == $case->service_id) selected @endif
                                                    value="{{ $service->uuid }}">{{ $service->name }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select id="sub_service" name="sub_service" class="form-select">
                                            ...
                                            @if ($sub_services->count() > 0)
                                                @foreach ($sub_services as $sub_service)
                                                    <option @if ($sub_service->uuid == $case->sub_service_id) selected @endif
                                                        value="{{ $sub_service->uuid }}">{{ $sub_service->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        ...
                                        <select id="inner_service" name="inner_service" class="form-select">
                                            ...
                                            @if ($inner_services->count() > 0)
                                                @foreach ($inner_services as $inner_service)
                                                    <option @if ($inner_service->uuid == $case->inner_service_id) selected @endif
                                                        value="{{ $inner_service->uuid }}">{{ $inner_service->name }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="title" name="title" class="form-control mb-2 summernote @if ($errors->has('title')) is-invalid @endif"
                                            placeholder="{{ __('Enter Title') }}" required>{{ @old('title', @$case->title) }}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="sub_title" name="sub_title" type="text"
                                            ...
                                            value="{{ @old('sub_title', @$case->subtitle) }}">
                                ...
                                <div class="mb-4 row">
                                    <label for="canonical_tag"
                                        class="col-sm-3 col-form-label mb-2">{{ __('Canonical Tag') }}</label>
                                    <div class="col-sm-9">
                                        <input id="canonical_tag" name="canonical_tag" type="text"
                                            ...
                                            value="{{ @old('canonical_tag', @$case->canonical_tag) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="schema"
                                            class="form-control  @if ($errors->has('schema')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Schema') }}" required>{{ @old('schema',@$case->schema)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content" class="form-control @if ($errors->has('content')) is-invalid @endif" style="width: 100% !important; height: 200px !important;"
                                            placeholder="{{ __('Enter Content Description') }}">{{ @old('content', @$case->content) }}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content2" class="form-control @if ($errors->has('content2')) is-invalid @endif" style="width: 100% !important; height: 200px !important;"
                                            placeholder="{{ __('Enter content') }}">{{ @old('content2', @$case->content2) }}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="button_title" name="button_title" type="text"
                                            ...
                                            value="{{ @old('button_title', @$case->button_title) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="seo_title" name="seo_title" type="text"
                                            ...
                                            value="{{ @old('seo_title', @$case->seo_title) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="seo_keywords" name="seo_keywords" type="text"
                                            ...
                                            value="{{ @old('seo_keywords', @$case->seo_keywords) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="seo_description" class="form-control @if ($errors->has('seo_description')) is-invalid @endif"
                                            placeholder="{{ __('Enter seo description') }}">{{ @old('seo_description', @$case->seo_description) }}</textarea>
