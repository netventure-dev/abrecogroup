    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Owener</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-7">
                            <form action="{{ route('admin.owner.store') }}" method="post" class="custom-validation"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4 row">
                                    <label for="no_of_owners" class="col-sm-3 col-form-label">Number of owner<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input id="no_of_owners" name="no_of_owners" type="text"
                                            class="form-control @if ($errors->has('no_of_owners')) is-invalid @endif"
                                            placeholder="Enter " required value="{{ @old('no_of_owners') }}">
