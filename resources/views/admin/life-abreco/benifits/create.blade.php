...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Create Benifits ') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{route('admin.benifits.store')}}" method="post" class="custom-validation" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4 row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Create Benifit  list  ') }}</h4>
                <div class="page-title-right">
        ...
        <div class="col-lg-12">
            <div class="card mb-0">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-12">
                            <form action="{{ route('admin.benifits-list.store') }}" method="post" class="custom-validation" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4 row">
                                    <label for="title" class="col-sm-3 col-form-label mb-2">{{ __('Title') }}<span
                                            class="text-danger"></span></label>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-12">
                            <h3 class="block-title">View Benifit List</h3>
                                        ...
                                        @if ($news->count())
                                            @foreach ($news as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="{{ route('admin.benifits-list.edit', $data->id) }}"
                                                            ...
                                                            <form id="delete-row-{{ $data->id }}" method="POST"
                                                                action="{{ route('admin.benifits-list.destroy', $data->id) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                        </div>
