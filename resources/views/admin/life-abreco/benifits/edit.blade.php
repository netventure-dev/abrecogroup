    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Edit Benefit List') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.benifits-list.update', $milestone->uuid) }}" method="post"
                                ...
                                <div class="mt-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        @if (isset($milestone->image))
                                            <img src="{{ asset('storage/'.$milestone->image) }}" alt="" class="img-fluid" style="width:150px;">
                                        @endif
