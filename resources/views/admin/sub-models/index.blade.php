...
@section('title') {{__('Sub-Models')}} @endsection
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">{{__('Sub-Models')}}</h4>
            <div class="page-title-right mt-5">
                {{-- @can('create', App\Models\Admin::class) --}}
                <a href="{{ route('admin.sub-models.create') }}"
                    class="btn btn-primary w-md">{{__('Create Sub Model')}}</a>
                {{-- @endcan --}}
            </div>
        </div>
    </div>
