...
@section('title') {{ __('Create Additional Page') }} @endsection
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Create Additional Page') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.additional-pages.store') }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content2"
                                            class="form-control @if ($errors->has('content2')) is-invalid @endif" placeholder="{{ __('Enter Content') }}" >{{ @old('content2')}}</textarea>
                                ...
                                <div class="mt-4 row">
                                 ...
                                 <div class="mb-4 row">
                                    <label for="logo_alt_text" class="col-sm-3 col-form-label mb-2">{{ __('Alt text') }}</label>
                                    <div class="col-sm-9">
                                        <input id="logo_alt_text" name="logo_alt_text" type="text"
                                            class="form-control mb-2 @if ($errors->has('logo_alt_text')) is-invalid  @endif"
                                            placeholder="{{ __('Enter alt text') }}"  value="{{ @old('logo_alt_text') }}">
