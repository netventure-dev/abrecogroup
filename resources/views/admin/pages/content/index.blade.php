    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Additional Page Content') }}</h4>
                <div class="page-title-right">
                         <a href="{{ route('admin.additional-content.create',@$subservice->uuid) }}"
                    ...
                    <table class="table table-bordered table-striped yajra-datatable" style="    background: #b2b2b2;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{!! $content->title !!}</td>
                                <td>{{$content->order}}</td>
                                <td> <a href="{{ route('admin.additional-content.edit',['id' => $subservice->uuid, 'uuid' =>$content->uuid]) }}" class="first btn btn-primary edit"> Edit</a>
                                ...
                                <form id="delete-data-{{ $content->uuid }}" action="{{ route('admin.additional-content.destroy',['id' => $subservice->uuid, 'uuid' =>$content->uuid]) }}"
                                    method="POST">
                                    @csrf
                                </form>
                            </td>
