        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.inner-services.content.store',@$subservice->uuid) }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description"
                                            class="form-control  @if ($errors->has('description')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Description') }}" >{{ @old('description')}}</textarea>
                                ...
                                <div class="mt-4 row">
                                    ...
                                    <div class="col-sm-9"> 
                                        ...
                                        <small>("Accepted formats: JPG, JPEG, PNG, and
                                            WEBP only.")</small><br><div class="invalid-feedback">{{ $errors->first('image') }}</div>
                                    </div>
                                </div>
                                 <div class="mt-4 row">
                                    <label class="col-sm-3 col-form-label" for="mobile_image">{{ __('Mobile Image') }} <a
                                            ...
                                            WEBP only.")</small> </label>
                                    <div class="col-sm-9"> 
                                        <input id="mobile_image" name="mobile_image" type="file" class="form-control mb-2 @if ($errors->has('image')) is-invalid @endif" value="{{ @old('mobile_image') }}">
                                        <small>("Accepted formats: JPG, JPEG, PNG, and
                                            WEBP only.")</small><br> <div class="invalid-feedback">{{ $errors->first('mobile_image') }}</div>
                                    </div>
                                </div>
