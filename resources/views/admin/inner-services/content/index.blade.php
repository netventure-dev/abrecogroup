    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Inner Service Content') }}</h4>
                <div class="page-title-right">
                         <a href="{{ route('admin.inner-services.content.create',@$subservice->uuid) }}"
                    ...
                    <table class="table table-bordered table-striped yajra-datatable" style="    background: #b2b2b2;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <button type="button" class="last btn btn-primary delete" data-toggle="tooltip" title="Delete" onclick="event.preventDefault(); if(confirm('{{__('Are you sure to delete this inner service content')}}')){
                                    document.getElementById('delete-data-{{ $content->uuid }}').submit();}">
                                    <i class="fas fa-trash-alt"></i>
                                </button>
                                <form id="delete-data-{{ $content->uuid }}" action="{{ route('admin.inner-services.content.destroy',['id' => $subservice->uuid, 'uuid' =>$content->uuid]) }}"
                                    method="POST">
                                    @csrf
                                </form>
                            </td>
