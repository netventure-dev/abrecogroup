                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="sub_service_id" required>
                                            <option selected value="">--Select Sub Service--</option>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="cover_description"
                                            class="ckeditor form-control @if ($errors->has('cover_description')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" placeholder="{{ __('Enter Cover Description') }}" required>{{ @old('cover_description')}}</textarea>
