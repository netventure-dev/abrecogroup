        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.services.faq.update', ['id'=>@$faq->uuid,'uuid' => @$services->uuid]) }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="title" name="title" type="text"
                                            ...
                                            placeholder="{{ __('Enter Title') }}" required value="{{ @old('title',@$faq->title) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description"
                                            class="form-control summernote @if ($errors->has('description')) is-invalid @endif" ro placeholder="{{ __('Enter Description') }}" required>{{ @old('description',@$faq->description)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="order" name="order" type="number" min="1" max="12"
                                            ...
                                            placeholder="{{ __('Enter order') }}" required value="{{ @old('order',@$faq->order) }}">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="status1"
                                                value="1" @if ($faq->status == 1) checked @endif>
                                            <label class="form-check-label" for="status1">{{ __('Active') }}</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="status" id="status2"
                                                value="0" @if ($faq->status == 0) checked @endif>
