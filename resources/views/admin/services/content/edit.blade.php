...
@section('title') {{ __('Edit Service Content') }} @endsection
@section('css')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.services.content.update',['id'=>@$services->uuid,'uuid' => @$content->uuid]) }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description"
                                            class="form-control summernote @if ($errors->has('description')) is-invalid @endif" ro placeholder="{{ __('Enter Description') }}" required>{{ @old('description',@$content->description)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="order" name="order" type="number" min="1" max="12"
                                            ...
                                            placeholder="{{ __('Enter order') }}" required value="{{ @old('order',@$content->order) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        placeholder="{{ __('Enter image_position') }}" required>
                                            ...
                                            <option @if(@$content->image_position == '1') selected @endif value="1">Center</option>
                                            <option @if(@$content->image_position == '2') selected @endif value="2">Left</option>
                                            <option @if(@$content->image_position == '3') selected @endif value="3">Right</option>
                                        </select>
                                ...
                                <div class="mb-4 row">
                                 ...
                                 <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        placeholder="{{ __('Enter Button Link') }}"  value="{{ @old('button_link',@$content->button_link) }}">
