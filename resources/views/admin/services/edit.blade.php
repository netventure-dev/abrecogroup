                            ...
                            <form action="{{ route('admin.services.update', $services->uuid) }}" method="post"
                                ...
                                <!-- <div class="mb-4 row">
                                    <label for="name" class="col-sm-3 col-form-label mb-2">{{ __('Name') }}<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <textarea id="name" name="name" class="form-control mb-2 summernote @if ($errors->has('name')) is-invalid @endif"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="alt_text" name="alt_text" type="text"
                                            ...
                                            value="{{ @old('alt_text', @$services->alt_text) }}">
                                ...
                                <!-- <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea id="title" name="title" class="form-control mb-2 summernote @if ($errors->has('title')) is-invalid @endif"
                                            placeholder="{{ __('Enter Title') }}" required>{{ @old('title', @$services->title) }}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="canonical_tag" name="canonical_tag" type="text"
                                            ...
                                            value="{{ @old('canonical_tag', @$services->canonical_tag) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="schema"
                                            class="form-control  @if ($errors->has('schema')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Schema') }}" required>{{ @old('schema',@$services->schema)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="custom_url" name="custom_url" type="text"
                                            ...
                                            value="{{ @old('custom_url', $services->custom_url) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="seo_description" name="seo_description" rows="2"
                                            placeholder="Please provide meta description">{{ @old('seo_description', @$services->seo_description) }}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="seo_keywords" name="seo_keywords" rows="2"
                                            placeholder="Please provide meta keywords">{{ @old('seo_keywords', @$services->seo_keywords) }}</textarea>
    ...
    <script>
        ...
        function delete_image(uuid) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: "{{ route('admin.services.image_delete') }}",
                    type: "get",
                    dataType: 'json',
                    data: {
                        uuid: uuid,
        ...
        function delete_image1(uuid) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: "{{ route('admin.services.image_delete1') }}",
                    type: "get",
                    dataType: 'json',
                    data: {
                        uuid: uuid,
