...
@section('title') {{ __('Create About Us') }} @endsection
@section('css')
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content"
                                            class="form-control summernote @if ($errors->has('content')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Description') }}" required>{{ @old('content',@$data->content)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="seo_description" name="seo_description" rows="2"
                                               ...
                                               >{{ @old('seo_keywords',@$data->seo_description) }}</textarea>
