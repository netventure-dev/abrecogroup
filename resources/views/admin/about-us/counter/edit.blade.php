    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Edit Counter') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                        <form action="{{ route('admin.couters.update', $data->uuid) }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    <label for="counter" class="col-sm-3 col-form-label mb-2">{{ __('Counter') }}<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input id="counter" name="counter" type="text"
                                            class="form-control mb-2 @if ($errors->has('counter')) is-invalid  @endif"
                                            placeholder="{{ __('Enter Counter') }}" required value="{{ @old('counter',@$data->counter) }}">
                                        <div class="invalid-feedback">{{ $errors->first('counter') }}
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="order" name="order" type="text"
                                            ...
                                            placeholder="{{ __('Enter order') }}" required value="{{ @old('order',@$data->order) }}">
