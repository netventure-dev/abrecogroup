...
@section('title') {{ __('Request Rate List') }} @endsection
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Create Request Rate List') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.request.list.store') }}" method="post"
                                ...
                                <div class="row mb-4">
                                    <label class="col-sm-3 col-form-label" for="service_care_id">Service Care
                                        <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <select id="service_care_id" name="service_care_id"
                                            class="form-control select2 @if ($errors->has('service_care_id')) is-invalid @endif"
                                            required>
                                            <option value="">Select Service Care</option>
                                            @foreach ($service_cares as $data)
                                                <option value={{ $data->id }}>{{ $data->name }}</option>
                                            @endforeach
    
                                        </select>
                                        <div class="invalid-feedback">{{ $errors->first('service_care_id') }}</div>
                                    </div>
                                </div>
                                <div class="mb-4 row">
                                    <label for="content"
