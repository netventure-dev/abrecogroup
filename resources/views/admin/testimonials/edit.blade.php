    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Edit Testimonial') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.testimonials.update', $data->uuid) }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="position" name="position" type="text"
                                            ...
                                            placeholder="{{ __('Enter position') }}" required value="{{ @old('position',@$data->position) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content"
                                            class="form-control  @if ($errors->has('content')) is-invalid @endif" ro placeholder="{{ __('Enter Content Description') }}" required>{{ @old('content',@$data->description)}}</textarea>
