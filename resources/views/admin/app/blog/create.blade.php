                                  ...
                                  <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="schema"
                                            class="form-control  @if ($errors->has('schema')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Schema') }}" required>{{ @old('schema',@$blog->schema)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description" class="form-control @if ($errors->has('description')) is-invalid @endif"
                                            style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter  Description') }}" required>{{ @old('description', @$blog->description) }}</textarea>
                                 ...
                                 <div class="mt-4 row">
                                    ...
                                    <div class="col-sm-9">
                                            @if (@$blog->mobile_image)
                                                <img src="{{ asset('/storage/' . @$blog->mobile_image) }}" alt=""
                                                    class="img-fluid" style="width:100px;">
                                                <button type="button" class="btn btn-primary w-md"
                                                    onclick="delete_image1('{{ $blog->uuid }}');"
                                                    class="close">Delete</button>
                                            @endif
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="seo_keyword" name="seo_keyword" type="text"
                                            ...
                                            value="{{ @old('seo_keyword', @$blog->seo_keyword) }}">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
         ...
         function delete_image(uuid) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: "{{ route('admin.blog-settings.image_delete') }}",
                    type: "get",
                    dataType: 'json',
                    data: {
                        uuid: uuid,
        ...
        function delete_image1(uuid) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: "{{ route('admin.blog-settings.image_delete_one') }}",
                    type: "get",
                    dataType: 'json',
                    data: {
                        uuid: uuid,
