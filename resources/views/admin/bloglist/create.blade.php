                                  ...
                                  <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="schema" class="form-control  @if ($errors->has('schema')) is-invalid @endif"
                                            style="width: 100% !important; height: 200px !important;" placeholder="{{ __('Enter Schema') }}">{{ @old('schema', @$data->schema) }}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="schedule_date" name="schedule_date" type="date"
                                            class="form-control mb-2 @if ($errors->has('schedule_date')) is-invalid @endif" value="{{ @old('schedule_date')}}">
