...
@section('title') {{ __('Create Contact Us') }} @endsection
@section('css')
                    ...
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.contact-us.store') }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    <label for="address"
                                            class="col-sm-3 col-form-label">{{ __('address') }}
                                            <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <textarea name="address"
                                            class="form-control summernote @if ($errors->has('address')) is-invalid @endif" ro placeholder="{{ __('Enter Description') }}" required>{{ @old('address',@$data->address)}}</textarea>
