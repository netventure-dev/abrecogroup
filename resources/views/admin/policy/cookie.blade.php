    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Cookie & Policy') }}</h4>
                        ...
                        <div class="col-lg-11">
                            <form action="{{ route('admin.cookie.store') }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                            <textarea name="title" class="form-control @if ($errors->has('title')) is-invalid @endif" ro
                                                placeholder="{{ __('Enter title') }}" required>{{ @old('title',@$cookie->title) }}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content"
                                            class="form-control @if ($errors->has('content')) is-invalid @endif" ro placeholder="{{ __('Enter Content') }}" required>{{ @old('content',@$cookie->content)}}</textarea>
                                ...
                                <div class="mt-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        @if (isset($cookie->image))
                                            <img src="{{ asset('storage/'.$cookie->image) }}" alt="" class="img-fluid" style="width:250px;">
                                        @endif
