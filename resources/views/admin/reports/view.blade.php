                    ...
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="" method="post" class="custom-validation" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 row">
                                    <label for="position" class="col-sm-3 col-form-label mb-2">{{ __('Service') }}<span
                                            class="text-danger"></span></label>
                                    <div class="col-sm-9">
                                        <input id="service" name="service" type="text"
                                            class="form-control mb-2 @if ($errors->has('service')) is-invalid @endif"
                                            placeholder="{{ __('Enter Service') }}" required
                                            value="{{ @old('service', @$quote->service) }}" readonly>
                                        <div class="invalid-feedback">{{ $errors->first('service') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4 row">
