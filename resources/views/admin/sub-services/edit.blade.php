                        ...
                        <div class="col-lg-11">
                            <form action="{{ route('admin.sub-services.update', $subservice->uuid) }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="cover_description"
                                            class="ckeditor form-control @if ($errors->has('cover_description')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Cover Description Description') }}" required>{{ @old('cover_description',@$subservice->cover_description)}}</textarea>
                                ...
                                <div class="mt-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        @if ($subservice->cover_image)
                                            <img src="{{ asset('storage/'.$subservice->cover_image) }}" alt="" class="img-fluid" style="width:250px;">
                                            <button type="button" class="btn btn-primary w-md" onclick="delete_image('{{ $subservice->uuid }}');"
                                 ...
                                 <div class="mt-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        @if ($subservice->logo)
                                            ...
                                            <button type="button" class="btn btn-primary w-md" onclick="delete_image1('{{ $subservice->uuid }}');"
                                            class="close">Delete</button>
                                            @endif
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="canonical_tag" name="canonical_tag" type="text"
                                            ...
                                            placeholder="{{ __('Enter canonical tag') }}"  value="{{ @old('canonical_tag',@$subservice->canonical_tag) }}">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="schema"
                                            class="form-control  @if ($errors->has('schema')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Schema') }}">{{ @old('schema',@$subservice->schema)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description"
                                            class="ckeditor form-control @if ($errors->has('description')) is-invalid @endif" style="width: 100% !important; height: 200px !important;" ro placeholder="{{ __('Enter Description') }}" required>{{ @old('description',@$subservice->description)}}</textarea>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="custom_url" name="custom_url" type="text"
                                            ...
                                            placeholder="{{ __('Enter Url') }}"  value="{{ @old('custom_url',$subservice->custom_url) }}">
...
@section('script')
   ...
   function delete_image(uuid) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: "{{ route('admin.sub-services.image_delete') }}",
                    type: "get",
                    dataType: 'json',
                    data: {
                        uuid: uuid,
        ...
        function delete_image1(uuid) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: "{{ route('admin.sub-services.image_delete1') }}",
                    type: "get",
                    dataType: 'json',
                    data: {
                        uuid: uuid,
