<div class="mt-2 btn-group btn-group-sm" role="group" aria-label="Admin Action">
    ...
    <button type="button" class="last btn btn-primary delete" data-toggle="tooltip" title="Delete" onclick="event.preventDefault(); if(confirm('{{__('Are you sure to delete this faq')}}')){
