    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">{{ __('Edit News') }}</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="mt-2 row">
                        <div class="col-lg-11">
                            <form action="{{ route('admin.office-location.update', $blog->uuid) }}" method="post"
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="sub_title" name="sub_title" type="text"
                                            ...
                                            placeholder="{{ __('Enter sub_title') }}" 
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="location_name" name="location_name" type="text"
                                            ...
                                            placeholder="{{ __('Enter location_name') }}" 
                                            value="{{ @old('location_name', @$blog->location_name) }}">
                                        <div class="invalid-feedback">{{ $errors->first('location_name') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4 row">
                                    <label for="location_url" class="col-sm-3 col-form-label mb-2">{{ __('Location name ') }}<span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input id="location_url" name="location_url" type="text"
                                            class="form-control mb-2 @if ($errors->has('location_url')) is-invalid @endif"
                                            placeholder="{{ __('Enter location_url') }}" 
                                            value="{{ @old('location_url', @$blog->location_url) }}">
    ...
    <script>
        ...
        function delete_image(uuid) {
            if (confirm("Are you sure?")) {
                $.ajax({
                    url: "{{ route('admin.news.image_delete') }}",
                    type: "get",
                    dataType: 'json',
                    data: {
                        uuid: uuid,
