...
class OurProjectsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->eloquent($query)
        ->addIndexColumn()
        ->editColumn('status', function (OurProjects $new) {
                if ($new->status) {
            ...
            ->editColumn('image', function (OurProjects $new) {
            if ($new->image) {
        ...
        ->addColumn('action', function (OurProjects $new) {
            return view('admin.our-projects.action', compact('new'));
        })
     ...
     *
     * @param \App\Models\OurProjectsDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(OurProjects $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('ourprojectsdatatable-table')
    ...
    {
        return 'OurProjects_' . date('YmdHis');
    }
}
