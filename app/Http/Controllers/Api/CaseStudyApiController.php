...
class CaseStudyApiController extends Controller
{
    ...
    {
        $data['case_studies'] = CaseStudy::select('id','slug','service_slug as service_id','inner_service_slug as inner_service_id','sub_service_slug as sub_service_id','uuid','title' , 'subtitle','image1','image2', 'content', 'content2', 'button_title','link', 'order','status')
